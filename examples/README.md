...
| [`08-modes.cpp`](08-modes.cpp) | What a round trip costs | The same twelve windows built one command at a time and folded into a single chain, timed side by side, then checked to have built the same thing. |
