...
require tmux 3.8 (including `3.8-rc`) or newer and preserve floating-pane metadata;
...
input; the two key-sending tools report every configured pane target when tmux
