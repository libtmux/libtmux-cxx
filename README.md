...
FetchContent_Declare(
  ...
  GIT_TAG        v0.1.0-alpha.6  # or a commit; never a moving branch
)
...
`v0.1.0-alpha.6` carries the caller-owned bounded asynchronous runtime and the
experimental x64 desktop Windows preview for Visual Studio 2022, including the
audited psmux build in its source. Whether a release's vcpkg port carries
